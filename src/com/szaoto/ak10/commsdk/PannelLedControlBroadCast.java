...
/*
 * 类名SerialPortControlBroadCast
 * 作者 liangdb
 * 主要功能 串口控制类
 * 创建日期2014年1月15日
 * 修改者，修改日期，修改内容
 */
public class PannelLedControlBroadCast {
...
//	public static int m_fd = -1;
	...
	public final static byte CMD_SATURATIONLIGHT	= 0x28;
	public final static byte CMD_CONTRASTLIGHT 		= 0x27;
	...
	public final static byte CloseBtndownAutoLight 	= 0x10;//关闭按键按下自动灯。（默认打开）
	public final static byte OpenBtndownAutoLight 	= 0x11;//打开按键按下自动灯
	public final static byte LightsAlwaysON 		= 0x2F;//常亮所有按键灯。
	public final static byte LightsAlwaysOFF 		= 0x3F;//关闭所有常亮按键灯
	
	byte[] cmd = new byte[CMD_LENGHT];

	public PannelLedControlBroadCast()
	{
	...
	public static int MakeLightsAlwaysON()
	{
		...
		return SerialPortControlBroadCast.WriteSerialPort(cmd);
	}
